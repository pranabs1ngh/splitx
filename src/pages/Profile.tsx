                    ...
                    <div className="mt-3">
                      <label className="flex items-center">
                        <input
                          ...
                          defaultChecked
                        />
                        <span className="ml-2 text-sm text-gray-700">Email notifications for new expenses</span>
                      </label>
                    </div>
                    <div className="mt-2">
                      <label className="flex items-center">
                        <input
                          ...
                          defaultChecked
                        />
                        <span className="ml-2 text-sm text-gray-700">Email notifications for settlements</span>
                      </label>
                    </div>
                  </div>
                </div>
